...
IN_DIR1="../8_3_97nohits_BlastnRes_counts"
SCRIPT="../../Parsers"
...
OUTFILENAME=$RUNNAME"_80to97hits_Portal.html"
rm -f ../$OUTFILENAME
...
echo -e "</head>" >> ../$OUTFILENAME
echo -e "<body bgcolor=\"#EFFBF8\">" >> ../$OUTFILENAME
echo -e "<a name=\"top\"></a>" >> ../$OUTFILENAME
echo -e "<font face=\"Tahoma\" size=\"6\">$RUNNAME Blastn 40%-97% hits portal</font><BR>" >> ../$OUTFILENAME
...
do
	FILE=${FNAME##*/}
	perl $SCRIPT/Html_portal_parser_97no.pl $IN_DIR1/$FILE >> ../$OUTFILENAME
