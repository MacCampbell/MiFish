...
do
	...
	then
		...
		perl $SCRIPT/BlastnRes.counts_JapaneseNameAddition_v5.pl $OUT_DIR1/$SAMPLE.blastn.deprep.counts.txt $SCRIPT/Sname_Jname.togodb.nonredundant.txt > $OUT_DIR1/$SAMPLE.blastn.JPnames.deprep.txt
	fi
done
